                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <a href="{{ route('partner.create') }}" class="btn btn-primary pull-left">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($partners as $partner)
                                        <tr>
                                            ...
                                            <td>{{ $i++ }}</td>
                                            <td>{!! $partner->name !!}</td>
                                            <td><img src="{{ asset('storage/' . $partner->image) }}" width="300"></td>
                                            <td width="20%" align="center">
                                                
                                                <a href="{{ route('partner.edit' , $partner->id) }}" title="تعديل" type="button" class="btn btn-primary btn-xs">
