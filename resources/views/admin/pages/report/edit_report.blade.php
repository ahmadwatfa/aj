    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="admin/offer-table">قائمة التقارير</a></li>
                <li class="active">اضافة تقرير جديد</li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"> اضافة تقرير <small>جديد</small> </h3>
                            <i class="pull-left header fa fa-th"></i>
                        </div><!-- /.box-header -->
                        <!-- form start -->

                        <form role="form" id="addOfferForm" method="post" action="{{ route('report.update' , $report->id) }}"
                                ...
                                <div class="col-md-8">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label">اسم الملف :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" placeholder=""
                                                    data-fv-field="" value="{{$report->name}}">
                                                @error('name')
