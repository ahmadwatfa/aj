      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
           ...
           <li class="active">اضافة مستخدم جديد</li>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"> اضافة مستخدم <small>جديد</small> </h3>
                  <i class="pull-left header fa fa-th"></i>
                </div><!-- /.box-header -->
                <!-- form start -->
                
                <form role="form" id="addUserForm" action="{{route('user.store')}}" method="post"  class="form-horizontal" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="col-md-8">
                   ...
                   <div class="col-md-12">
                    <div class="form-group">
                     <label class="col-sm-3 control-label">الايميل  :</label>
                     <div class="col-sm-9">
                       <input type="email" class="form-control"  id="email" name="email" placeholder="" data-fv-field="">
                       @error('email')
                       <p class="text-danger">{{ $message }}</p>
                       @enderror
                     </div>
                  ...
                  {{-- <div class="col-md-4">
                      ...
                      <div class="file-upload">
                          ...
                          <div class="image-upload-wrap">
                            <input class="file-upload-input" id="img" name="img" type='file' onchange="readURL(this);" accept="image/*" />
                            <div class="drag-text">
                              <h3>إضافة صورة المستخدم </h3>
                            </div>
                          </div>
